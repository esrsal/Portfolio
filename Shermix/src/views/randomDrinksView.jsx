...
function RandomDrinksView(props) {
    return (<div className="drinks-container">
        <div>
            <section>
                <div className="drinks-intro">
                    <h1>Cocktails</h1>
                    <p><h3>Discover Your Next Favorite Cocktail! </h3>
                        Welcome to the thrill of the unexpected at Shermix. Here you can find a surprise mix from our extensive collection. It's a simple way to explore new flavors and find your next favorite cocktail with just a click!
                    </p>
                </div>
            </section>
...
export default RandomDrinksView;